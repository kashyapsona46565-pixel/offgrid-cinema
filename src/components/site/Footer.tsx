...
import { PHONE_DISPLAY, ADDRESS_LINE, CALL_HOURS, WHATSAPP_HOURS } from "@/data/villa";
    ...
    <div className="mx-auto grid max-w-7xl gap-10 px-6 py-14 md:grid-cols-4">
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm text-muted-foreground">
          ...
          <li><Link to="/availability" className="hover:text-primary">Booking & Enquiry</Link></li>
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm text-muted-foreground">
          <li>{ADDRESS_LINE}</li>
          <li>{PHONE_DISPLAY}</li>
          <li>Call: {CALL_HOURS} · WhatsApp: {WHATSAPP_HOURS}</li>
        </ul>
      </div>
    </div>
